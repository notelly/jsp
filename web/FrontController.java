...
import co.yedam.notice.command.RemoveEventJson;
...
public class FrontController extends HttpServlet{
	...
	public void init() throws ServletException {
		...
		//이벤트 정보
		map.put("/allEventsJson.do", new AllEventsJson());
		map.put("/addEvent.do", new AddEventJson());
		map.put("/removeEvent.do", new RemoveEventJson());
		map.put("/calendar.do", new FullCalendarDo());
